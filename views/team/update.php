...
<body class="g-sidenav-show bg-gray-100">
                    ...
                    <div class="card">
                        ...
                        <form action="http://php_mvc_oop.test/Team/addaction" id="addteamform" enctype="multipart/form-data">
							...
							<div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" value="<?php echo $rows['team_name']  ?>" name="team_name" id="team_name" placeholder="Enter team name" required>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="league_name" value="<?php echo $rows['league_name']  ?>" id="league_name" class="form-control" placeholder="leage name">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <button type="submit" id="submit" class="btn btn-primary btn-block">Update Team</button>
                                    </div>
                                </div>
    ...
    <script src="http://php_mvc_oop.test/public/assets/js/popper.min.js"></script>
